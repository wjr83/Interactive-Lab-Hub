...
def display_LED_lose(my_stick, minus_who_p, p1_score, p2_score, red_list, green_list, blue_list, LED_length):
    ...
    while True:
        ...
        if is_score == False:
            if p == 0:
                ...
                p2_score +=1
            display_LED_lose(my_stick, p, p1_score, p2_score, red_list, green_list, blue_list, LED_length)
